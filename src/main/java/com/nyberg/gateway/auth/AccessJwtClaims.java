 ...
 * Gateway does not validate signatures; backends still enforce auth.
 */
public final class AccessJwtClaims {

    private static final TypeReference<Map<String, Object>> MAP = new TypeReference<>() {};

    private AccessJwtClaims() {}

    public static Claims parse(ObjectMapper mapper, String authorizationHeader) {
        ...
        try {
            ...
            if (clientId == null) {
                // API-key JWTs use app_id instead of client_id
    ...
    public record Claims(String organizationId, String clientId) {}
}
